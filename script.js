function evaluateQuiz() {
    ...
    if (q1 && q1.value == "1") { score++; mark("q1box", true); }
    ...
    if (form.q3.value == "1") { score++; mark("q3box", true); }
    else mark("q3box", false);

    if (form.q4.value == "3") { score++; mark("q4box", true); }
    else mark("q4box", false);

    let ans5 = form.q5.value.toLowerCase();
    if (ans5.includes("gwyn") || ans5.includes("nito") || ans5.includes("seath")) {
        score++; mark("q5box", true);
    } else mark("q5box", false);

    let q6 = document.querySelector('input[name="q6"]:checked');
    if (q6 && q6.value == "1") { score++; mark("q6box", true); }
    ...
    if (form.q9.value == "4") { score++; mark("q9box", true); }
    else mark("q9box", false);

    let q10 = document.querySelector('input[name="q10"]:checked');
    if (q10 && q10.value == "1") { score++; mark("q10box", true); }
